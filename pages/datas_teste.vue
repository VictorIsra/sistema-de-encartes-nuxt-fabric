...
<script>
  ...
  export default {
    props: {
        checkDataRange: {//tabela precisa q as datas fiquem dentro de um intervalo, daí ela envia essa prop preenchida
          ...
          default: function(){
            return{
              checkRange: false,
              Pdata_i: '1/1/2004', //de 'parent data inicio'
              Pdata_f: '2/2/2005'
            }  
          }
        },
    ...
    data: () => ({
      ...
      dateFormatted_inicio:'2/2/2018', 
      dateFormatted_termino:'2/2/2020',
      menu1: false,
      menu2: false,
      counter: 0
    }),
    ...
    methods: {
      setDatesRange(){//seta o intervalo de datas em que os produtos devem estar ( datas form definidas na etapa 1)
        console.log("hmmmm")
       this.checkDataRange.Pdata_i = '1/1/2018'///this.$store.state.campanhas.formInputs.data_inicio
        this.checkDataRange.Pdata_f = '1/1/2020'//this.$store.state.campanhas.formInputs.data_termino
      },
      formatDate (date) {
        if (!date)
          return null
      ...
      console.log("entradas ", dateFrom, dateTo,dateCheck,flag)
      ...
      dataRule(v){   
        if(!this.checkDataRange.checkRange)
          ...
          if(v !== '' && this.defaultDatesValues.flag !== -1){
            ...
            console.log("entradas ",this.checkDataRange.Pdata_i)
